		...
		starlight({
			...
			sidebar: [
				...
				},
				{
					...
					items: [
						{ label: 'Packages', link: '/breakdown/packages/' },
						{ label: 'Populating Variables', link: '/breakdown/variables/' },
						{ label: 'Embeds', link: '/breakdown/embeds/' },
						{ label: 'Slash Commands', link: '/breakdown/commands/' },
						{ label: 'Processing Server Output', link: '/breakdown/output/' },
					]
				},
